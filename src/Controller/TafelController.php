...
class TafelController extends AbstractController
{
    ...
    {
        return $this->render('tafel/index.html.twig', ['tafels' => $tafelRepository->findAll()]);
    }
    ...
    {
        return $this->render('tafel/show.html.twig', ['tafel' => $tafel]);
    }
    ...
    public function edit(Request $request, Tafel $tafel): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('tafel_edit', ['id' => $tafel->getId()]);
        }
